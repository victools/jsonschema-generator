...
/**
 * Test for the {@link MicroProfileOpenApi3Module} class.
 */
public class MicroProfileOpenApi3ModuleTest {
    ...
    public void testApplyToConfigBuilder() {
        new MicroProfileOpenApi3Module().applyToConfigBuilder(this.configBuilder);
