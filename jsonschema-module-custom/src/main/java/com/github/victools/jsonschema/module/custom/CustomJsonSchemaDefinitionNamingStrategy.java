 ...
 */
public class CustomJsonSchemaDefinitionNamingStrategy implements SchemaDefinitionNamingStrategy {
     ...
     */
    public CustomJsonSchemaDefinitionNamingStrategy(SchemaDefinitionNamingStrategy baseStrategy) {
    ...
    public String getDefinitionNameForKey(DefinitionKey key, SchemaGenerationContext generationContext) {
        JsonSchema annotation = key.getType().getErasedType().getAnnotation(JsonSchema.class);
