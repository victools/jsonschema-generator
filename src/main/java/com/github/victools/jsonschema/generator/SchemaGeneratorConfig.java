...
public interface SchemaGeneratorConfig {
     ...
     */
    List<InstanceAttributeOverride<AnnotatedField>> getFieldAttributeOverrides();
     ...
     * @return overrides of a given JSON Schema node's instance attributes
     */
    List<InstanceAttributeOverride<AnnotatedMethod>> getMethodAttributeOverrides();

    /**
     * Check whether a field/property is nullable.
     *
     * @param field object's field/property to check
     * @param fieldType associated field type (affected by {@link #resolveTargetTypeOverride(AnnotatedField, JavaType, BeanDescription)})
     * @param declaringContext the declaring type's description
     * @return whether the field/property is nullable
     */
    boolean isNullable(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * {@link #resolveTargetTypeOverride(AnnotatedMethod, JavaType, BeanDescription)})
     * @param declaringContext the declaring type's description
     * @return whether the method's return value is nullable
     */
    boolean isNullable(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    boolean shouldIgnore(AnnotatedField field, BeanDescription declaringContext);
     ...
     */
    boolean shouldIgnore(AnnotatedMethod method, BeanDescription declaringContext);
     ...
     */
    JavaType resolveTargetTypeOverride(AnnotatedField field, JavaType defaultType, BeanDescription declaringContext);
     ...
     * @return target type (may be null)
     */
    JavaType resolveTargetTypeOverride(AnnotatedMethod method, JavaType defaultType, BeanDescription declaringContext);
     ...
     * @param declaringContext the declaring type's description
     */
    String resolvePropertyNameOverride(AnnotatedField field, String defaultName, BeanDescription declaringContext);
     ...
     * @param declaringContext the declaring type's description
     */
    String resolvePropertyNameOverride(AnnotatedMethod method, String defaultName, BeanDescription declaringContext);
     ...
     */
    String resolveTitle(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "title" in a JSON Schema (may be null)
     */
    String resolveTitle(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    String resolveDescription(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "description" in a JSON Schema (may be null)
     */
    String resolveDescription(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    Collection<?> resolveEnum(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "enum"/"const" in a JSON Schema (may be null)
     */
    Collection<?> resolveEnum(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    Integer resolveStringMinLength(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "minLength" in a JSON Schema (may be null)
     */
    Integer resolveStringMinLength(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    Integer resolveStringMaxLength(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "maxLength" in a JSON Schema (may be null)
     */
    Integer resolveStringMaxLength(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    String resolveStringFormat(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "format" in a JSON Schema (may be null)
     */
    String resolveStringFormat(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    BigDecimal resolveNumberInclusiveMinimum(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "minimum" in a JSON Schema (may be null)
     */
    BigDecimal resolveNumberInclusiveMinimum(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    BigDecimal resolveNumberExclusiveMinimum(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "exclusiveMinimum" in a JSON Schema (may be null)
     */
    BigDecimal resolveNumberExclusiveMinimum(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    BigDecimal resolveNumberInclusiveMaximum(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "maximum" in a JSON Schema (may be null)
     */
    BigDecimal resolveNumberInclusiveMaximum(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    BigDecimal resolveNumberExclusiveMaximum(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "exclusiveMaximum" in a JSON Schema (may be null)
     */
    BigDecimal resolveNumberExclusiveMaximum(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    BigDecimal resolveNumberMultipleOf(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "multipleOf" in a JSON Schema (may be null)
     */
    BigDecimal resolveNumberMultipleOf(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    Integer resolveArrayMinItems(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "minItems" in a JSON Schema (may be null)
     */
    Integer resolveArrayMinItems(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    Integer resolveArrayMaxItems(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "maxItems" in a JSON Schema (may be null)
     */
    Integer resolveArrayMaxItems(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
     ...
     */
    Boolean resolveArrayUniqueItems(AnnotatedField field, JavaType fieldType, BeanDescription declaringContext);
     ...
     * @return "uniqueItems" in a JSON Schema (may be null)
     */
    Boolean resolveArrayUniqueItems(AnnotatedMethod method, JavaType returnValueType, BeanDescription declaringContext);
}
