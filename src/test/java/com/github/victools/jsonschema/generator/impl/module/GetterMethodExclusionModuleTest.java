...
/**
 * Test for the {@link GetterMethodExclusionModule} class.
 */
@RunWith(JUnitParamsRunner.class)
public class GetterMethodExclusionModuleTest {

    private GetterMethodExclusionModule instance;
    private SchemaGeneratorConfigBuilder builder;
    private SchemaGeneratorConfigPart<Method> methodConfigPart;

    @Before
    public void setUp() {
        this.instance = new GetterMethodExclusionModule();
